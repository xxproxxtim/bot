async function createCmd(client, guildId){
    const data = [
        ...
        {
            name: 'new',
            description: 'Maakt een ticket in onze discord',
            options: [
            {
                name: 'text',
                description: 'Voegt de text toe aan de ticket!',
                type: 'STRING',
                required: true
            },
            {
                name: 'perms',
                description: 'Voegt een perm toe!',
                type: 'STRING',
                required: true,
                    choices: [
                    {
                        name: 'Support-team',
                        description: 'Krijg een tickt waar iedereen in kan die bij het staff-team hoord.',
                        value: 'supportteam'
                    },
                    {
                        name: 'hc+',
                        description: 'Krijg een ticket waar alleen hc in kan.',
                        value: 'hcteam'
                    },
                    {
                        name: 'management+',
                        description: 'Krijg een ticket waar alleen management in kan.',
                        value: 'managementteam'
                    },
                    {
                        name: 'developers',
                        description: 'Krijg een ticket waar alleen de developers in kunnen.',
                        value: 'developerteam'
                    },
                    {
                        name: 'creators',
